...
namespace ClinicDent.Controllers
{
    public class CitasController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Estados = new SelectList(new List<string> { "Pendiente", "Confirmada", "Cancelada", "Completada" });
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.id_dentista = new SelectList(db.Dentistas, "id_dentista", "nombre", citas.id_dentista);
            ViewBag.id_paciente = new SelectList(db.Pacientes, "id_paciente", "nombre", citas.id_paciente);
            // Lista de estados posibles con el estado actual seleccionado
            ViewBag.Estados = new SelectList(new List<string> { "Pendiente", "Confirmada", "Cancelada", "Completada" }, citas.estado);
            return View(citas);
        }
